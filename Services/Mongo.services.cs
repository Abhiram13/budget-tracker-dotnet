...
namespace BudgetTracker.Services
{
    ...
    {
        private static readonly string url = Environment.GetEnvironmentVariable("ENV") == "Test" ? "mongodb://localhost:27017/" : $"mongodb+srv://{Env.USERNAME}:{Env.PASSWORD}@{Env.HOST}/?retryWrites=true&w=majority&appName=Trsnactions";
